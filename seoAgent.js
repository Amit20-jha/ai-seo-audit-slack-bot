...
async function generateReport(scrapedData) {
  const prompt = `
You are an expert SEO Analyst. Please review the following scraped SEO data for a website and generate a detailed SEO Audit Report.

Website Data:
${JSON.stringify(scrapedData, null, 2)}

Provide separate detailed reports of all the following:
- SEO AUDIT REPORT
